...
```bash
git clone https://github.com/<USERNAME>/babel-plugin-auto-css-modules.git
cd babel-plugin-auto-css-modules
git remote add upstream https://github.com/dogma-io/babel-plugin-auto-css-modules.git
```

**SSH**

```bash
git clone git@github.com:<USERNAME>/babel-plugin-auto-css-modules.git
cd babel-plugin-auto-css-modules
git remote add upstream git@github.com:dogma-io/babel-plugin-auto-css-modules.git
```
...
[fork-repo]: https://github.com/dogma-io/babel-plugin-auto-css-modules#fork-destination-box
